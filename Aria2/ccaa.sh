...
if [ $1 = 'cdn' ]
	then
	aria2_url='https://cdn.jsdelivr.net/gh/xzc08218/cdn/Aria2/aria2-1.35.0-linux-gnu-64bit-build1.tar.bz2'
	filebrowser_url='https://cdn.jsdelivr.net/gh/xzc08218/cdn/Aria2/linux-amd64-filebrowser.tar.gz'
	master_url='https://cdn.jsdelivr.net/gh/xzc08218/cdn/Aria2/master.zip'
	ccaa_web_url='https://cdn.jsdelivr.net/gh/xzc08218/cdn/Aria2/ccaa_web.tar.gz'
	else
